...
public class ActionAnalysisChart {
	...
	@ResponseBody
	public String createAnalysisChart(AnalysisChartEntity analysisChartEntity) {
		try {
			analysisChartService.addAnalysisChart(analysisChartEntity);
			return I18N.getString("com.esen.abistudy.actionanalysischart.successmsg","生成分析表成功！");
		}catch (Exception e) {
			return I18N.getString("com.esen.abistudy.actionanalysischart.failmsg","生成分析表失败！");
		}	
	}
	/**
